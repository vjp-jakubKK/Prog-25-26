...
public class Ejercicio26 {
    ...
    public static void main(String[] args) {
        int numero, primeraCifra, segundaCifra, terceraCifra, cuartaCifra;  // creamos las variables para el ejercicio 
        
        Scanner entrada = new Scanner (System.in); // iniciamos el scanner
        
        System.out.println("Introduzca un numero de 4 cifras: "); // pedimos al usuario las 4 cifras
